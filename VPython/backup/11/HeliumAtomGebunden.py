...
sphere(pos=vector(20,0,0),radius=0.2,color=color.blue,charge=-sqrt(10),mass=1,velocity=vector(0,0,0.75),a=vector(0,0,0),trail=curve(color=color.blue)),
...
sphere(pos=vector(-20,0,0),radius=0.2,color=color.white,charge=-sqrt(10),mass=1,velocity=vector(0,0,-0.75),a=vector(0,0,0),trail=curve(color=color.white)),
