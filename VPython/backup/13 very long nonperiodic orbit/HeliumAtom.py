...
spheres = [
sphere(pos=vector(0,0,0),radius =0.6,color=color.red,charge=20,mass=7200,velocity=vector(0,0,0),a = vector(0,0,0),trail=curve(color=color.red)),
sphere(pos=vector(0,0,20),radius=0.2,color=color.blue,charge=-1,mass=1,velocity=vector(2,0,0),a=vector(0,0,0),trail=curve(color=color.blue)),
...
sphere(pos=vector(0,-20,0),radius=0.2,color=color.white,charge=-1,mass=1,velocity=vector(-2,0,0),a=vector(0,0,0),trail=curve(color=color.white)),
