...
sphere(pos=vector(8,0,0),radius=0.2,color=color.blue,charge=-sqrt(10),mass=1,velocity=vector(0,0.3,0.75),a=vector(0,0,0),trail=curve(color=color.blue)),
...
sphere(pos=vector(0,5,0),radius=0.2,color=color.white,charge=-sqrt(10),mass=1,velocity=vector(2,0,0),a=vector(0,0,0),trail=curve(color=color.white)),
