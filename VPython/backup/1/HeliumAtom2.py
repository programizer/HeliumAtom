...
spheres = [
sphere(pos=vector(0,0,0),radius =0.6,color=color.red,mass=1,velocity=vector(0,0,0),a = vector(0,0,0),trail=curve(color=color.red)),
sphere(pos=vector(0,10,0),radius=0.2,color=color.blue,mass=-1,velocity=vector(3,3,0),a=vector(0,0,0),trail=curve(color=color.blue)),
...
sphere(pos=vector(0,-10,0),radius=0.2,color=color.white,mass=-1,velocity=vector(0,-2,-4),a=vector(0,0,0),trail=curve(color=color.white)),
