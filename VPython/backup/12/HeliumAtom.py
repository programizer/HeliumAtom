...
spheres = [
sphere(pos=vector(0,0,0),radius =0.6,color=color.red,charge=2,mass=7200,velocity=vector(0,0,0),a = vector(0,0,0),trail=curve(color=color.red)),
sphere(pos=vector(8,0,0),radius=0.2,color=color.blue,charge=-1,mass=1,velocity=vector(0,0,0.25),a=vector(0,0,0),trail=curve(color=color.blue)),
...
sphere(pos=vector(0,4,0),radius=0.2,color=color.white,charge=-1,mass=1,velocity=vector(-1,0,0),a=vector(0,0,0),trail=curve(color=color.white)),
